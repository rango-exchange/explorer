...
import { CopyIcon, InfoIcon, LinkIcon, MoreIcon } from 'src/components/icons';
...
function TransactionURLMobileItem(props: TransactionURLItemProps) {
  ...
  return (
    <div className="mb-5 md:mb-10 bg-neutral-900 p-5 md:px-10 md:py-12 rounded-micro flex md:hidden items-center justify-between">
...
export default TransactionURLMobileItem;
