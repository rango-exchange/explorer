    ...
    <>
      <div className="relative" ref={menuRef as LegacyRef<HTMLDivElement>}>
        <button
          ...
          <Image className="lg:w-9 lg:h-9" src={burger_menu} alt="menu" />
        </button>
        <div
          ...
          <Link
            href="/"
            className="flex items-center font-semibold hover:text-primary text-16 lg:hidden mb-8"
            onClick={closeMenu}>
            <Image
              className="mr-3.5"
              src={dashboard}
          ...
          <div
            ...
            <div className="flex items-center">
              ...
              />
              <p className="text-16 font-semibold lg:font-bold lg:text-base">
                Resources
              </p>
            </div>
            {isOpenSubmenu ? (
          ...
          <div
            ...
            {links.map((link) => (
              <p key={`link-${link.id}`} className="text-12 pb-5 lg:text-base">
                <a
                  href={link.location}
                  target="_blank"
